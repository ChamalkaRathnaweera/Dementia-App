...
const EditPatient = ({route}) => {
  ...
  const { patient,fetchData } = route.params;
    ...
    <View style={styles.loginFormContainer}>
      <View style={styles.inputCotainer}>
        ...
        {String(idNo).substring(2, 5) >= 500 ? (
          <TextInput style={styles.input} placeholder="Age" value={"Female"} />
        ) : (
          <TextInput style={styles.input} placeholder="Age" value={"Male"} />
        )}
      </View>
